        ...
        <div id="content">
            ...
            <div class="container">
                <div class="page-header">
                    ...
                    <button class="button" id="btn1" type="submit" onClick="location.href='add/addclass.html'"> 강의 추가 </button>
                    <button class="button" id="btn2" type="submit" onClick="location.href='add/addhw.html'"> 과제 추가 </button>
